    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('media', models.FileField(blank=True, help_text='Media', upload_to='media/comment/%Y/%m/%d/')),
            ],
            options={
                'ordering': ['-uid'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.CharField(help_text='Enter Content', max_length=100)),
                ('media', models.FileField(blank=True, help_text='Media', upload_to='media/content/%Y/%m/%d/')),
